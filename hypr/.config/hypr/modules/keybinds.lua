...
-- Requires playerctl for media playback controls.
...
-- hl.bind("Print", hl.dsp.exec_cmd("/home/lolleo/.local/bin/screenshot-copy"))
hl.bind("Print", hl.dsp.exec_cmd("/home/lolleo/.local/bin/rishot")) 

-- -- Area screenshot -> edit with swappy
-- hl.bind("SHIFT + Print", hl.dsp.exec_cmd("/home/lolleo/.local/bin/screenshot-edit-copy"))
