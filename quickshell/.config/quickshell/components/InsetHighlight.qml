...
Item {
    ...
    Canvas {
        ...
        onPaint: {
            ...
            const edge = root.theme.geometry.frameWidth
            ...
            context.lineTo(width - edge - radius, radius)
            context.quadraticCurveTo(width - edge, radius, width - edge, 0)
            context.lineTo(width, 0)
            context.lineTo(width, height)
            context.lineTo(width - edge, height)
            context.quadraticCurveTo(width - edge, height - radius,
                                     width - edge - radius, height - radius)
